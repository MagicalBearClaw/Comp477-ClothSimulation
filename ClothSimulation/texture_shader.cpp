...
TextureShader::TextureShader(RenderContext* renderContext) : _renderContext(renderContext)
{
...
bool TextureShader::Render(int indexCount, DirectX::XMFLOAT4X4 worldMatrix, DirectX::XMFLOAT4X4 viewMatrix, DirectX::XMFLOAT4X4 projectionMatrix, ID3D11ShaderResourceView* texture)
{
...
bool TextureShader::InitializeShader(ID3D11Device* device, HWND windowHandle, const WCHAR* vsFilename, const WCHAR* psFilename)
{
	HRESULT result;
...
bool TextureShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, DirectX::XMFLOAT4X4 world, DirectX::XMFLOAT4X4 view, DirectX::XMFLOAT4X4 projection, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
